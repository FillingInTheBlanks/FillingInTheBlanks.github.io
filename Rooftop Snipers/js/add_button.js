!function (){
  let identifier=chrome.runtime.id.substr(0,6),
    ...
    relevant=path.indexOf('search')!==-1;
  if (!relevant)
    return;
  ...
  if (!relevant||locSearch.indexOf('tbm=isch')!==-1||locSearch.indexOf('tbm=vid')!==-1)
    return;
  ...
  relevant=q&&q.indexOf('Rooftop Snipers Game'.toLowerCase())!==-1;
  ...
  if (relevant&&typeof window[identifier]==='undefined'){
    ...
    window.addEventListener('load',function(){
      ...
      box.innerHTML='<div class="game-button-icon-box"></div>' +
        '<div class="game-button-section"><div class="game-button-title">Rooftop Snipers Game</div>' +
